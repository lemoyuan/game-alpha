...
export const PLAYER_ATK = 10;           // 初始攻击力，=子弹伤害（升级项：攻击力 +5）
...
export const PLAYER_CRIT_RATE = 0.05;   // 初始暴击率（升级项：暴击率 +5%）
...
export const UPGRADES = [
  ...
  { key: 'attack',   label: '攻击力',   desc: '+5',   value: 5 },
  { key: 'defence',  label: '防御力',   desc: '+2',   value: 2 },
  { key: 'atkSpeed', label: '攻击速度', desc: '+0.3次', value: 0.3 }, // 加法叠加：1.0 → 1.3 → 1.6 次/秒
  { key: 'attackRange', label: '攻击距离', desc: '+20',  value: 20 },
  { key: 'critRate', label: '暴击率',   desc: '+5%',  value: 0.05 },
