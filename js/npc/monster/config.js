...
export const MONSTER_TYPES = {
  basic:  { hp: 15, speed: 60,  radius: 14, color: '#16a085', xp: 2,  damage: 8, weight: 1 },  // 青色普通怪
  fast:   { hp: 8,  speed: 130, radius: 10, color: '#e67e22', xp: 3,  damage: 4, weight: 1 },  // 橙色快速怪
  tank:   { hp: 45, speed: 35,  radius: 22, color: '#8e44ad', xp: 5,  damage: 12, weight: 1 }, // 紫色坦克怪
